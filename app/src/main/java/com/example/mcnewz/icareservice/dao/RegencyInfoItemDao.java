...
public class RegencyInfoItemDao {
    ...
    private String SumDepartmentSelect;

    public String getSumDepartmentSelect() {
        return SumDepartmentSelect;
    }

    public void setSumDepartmentSelect(String sumDepartmentSelect) {
        SumDepartmentSelect = sumDepartmentSelect;
    }
